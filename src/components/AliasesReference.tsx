...
const aliases: Alias[] = [
  // Essential
  {
    alias: "k",
    command: "kubectl",
    description: "Short form for kubectl",
    category: "Essential",
    example: "k get pods",
  },
  {
    ...
    description: "List pods quickly",
    category: "Essential",
    example: "kgp -n production",
  },
  {
    alias: "kgpa",
  ...
  },
  {
    ...
    category: "Essential",
    example: "kgs -n default",
  },
  {
    alias: "kgn",
    command: "kubectl get nodes -o wide",
    description: "List nodes with details",
    category: "Essential",
    example: "kgn",
  },
  {
  ...
  },
  {
    ...
    description: "List warning events sorted by time",
    category: "Essential",
    example: "kgew",
  },
  ...
  },
  {
    ...
    category: "Describe",
    example: "kdpvc my-claim",
  },
  {
    alias: "kdsa",
    command: "kubectl describe sa",
    description: "Describe ServiceAccount",
    category: "Describe",
    example: "kdsa default",
  },
  {
    alias: "kexp",
    command: "kubectl explain",
    description: "Explain resource",
    category: "Describe",
    example: "kexp pod.spec",
  },
  ...
  // Logs & Debugging
  {
    ...
    category: "Logs & Debug",
    example: "kl my-pod -c app",
  },
  {
    alias: "klp",
    command: "kubectl logs -f --previous",
    description: "Stream previous logs",
    category: "Logs & Debug",
    example: "klp my-pod",
  },
  {
    alias: "klt",
    command: "kubectl logs -f --tail=100",
    description: "Stream last 100 lines",
    category: "Logs & Debug",
    example: "klt my-pod",
  },
  {
    alias: "klall",
    command: "kubectl logs -f --all-containers=true",
    description: "Stream logs from all containers",
    category: "Logs & Debug",
    example: "klall my-pod",
  },
  {
    alias: "kpf",
  ...
  // Exec
  {
    ...
    description: "Execute into pod",
    category: "Exec",
    example: "kex my-pod -- /bin/sh",
  },
  {
    alias: "kesh",
    command: "kubectl exec -it $1 -- /bin/sh",
    description: "Get shell in pod (requires function)",
    category: "Exec",
    example: "kesh my-pod",
  },
  {
    alias: "kebash",
    command: "kubectl exec -it $1 -- /bin/bash",
    description: "Get bash in pod (requires function)",
    category: "Exec",
    example: "kebash my-pod",
  },
  ...
  // Apply & Delete
  {
    ...
    description: "Apply from file",
    category: "Operations",
    example: "kaf deployment.yaml",
  },
  {
    alias: "kafd",
    command: "kubectl apply -f . --recursive",
    description: "Apply all in directory",
    category: "Operations",
    example: "kafd",
  },
  {
  ...
  },
  {
    ...
    category: "Operations",
    example: "kdelall pods --namespace=dev",
  },
  {
    alias: "kdiff",
    command: "kubectl diff -f",
    description: "Diff file against cluster",
    category: "Operations",
    example: "kdiff deployment.yaml",
  },
  {
    alias: "kcp",
    command: "kubectl cp",
    ...
    category: "Operations",
    example: "kcp ./local-file my-pod:/tmp/remote-file",
  },
  ...
  // Advanced & Formats
  {
    ...
    description: "List pods with details",
    category: "Advanced",
    example: "kgpw -n production",
  },
  {
    alias: "kgpww",
    command: "kubectl get pods -o wide --watch",
    description: "Watch pods with details",
    category: "Advanced",
    example: "kgpww",
  },
  {
    ...
    category: "Advanced",
    example: "kgpoy my-pod",
  },
  {
    alias: "kgpoj",
    command: "kubectl get pods -o json",
    description: "Get pod JSON",
    category: "Advanced",
    example: "kgpoj my-pod",
  },
  {
    alias: "kgpon",
    command: "kubectl get pods --no-headers",
    description: "Get pods without headers (for scripts)",
    category: "Advanced",
    example: "kgpon",
  },
  {
  ...
  // JSONPath & Filtering
  {
    alias: "kip",
    command:
      "kubectl get pods -o custom-columns=POD:.metadata.name,IP:.status.podIP --no-headers",
    description: "Get Pod IPs",
    category: "JSONPath & Filters",
    example: "kip",
  },
  {
    alias: "kimg",
  ...
  // Security
  {
    ...
    category: "Security",
    example: "kcan create pods --as=jane",
  },
  {
    alias: "kroles",
    command: "kubectl get roles,clusterroles",
  ...
  {
    alias: "kbinds",
    command: "kubectl get rolebindings,clusterrolebindings",
  ...
  // Rollout & Scaling
  {
    ...
    category: "Operations",
    example: "kroll status deploy/web",
  },
  {
    alias: "krollh",
  ...
  },
  {
    ...
    category: "Operations",
    example: "ksc deploy/web --replicas=3",
  },
  {
    alias: "kaut",
    command: "kubectl autoscale",
    description: "Autoscale resources",
    category: "Operations",
    example: "kaut deploy/web --min=2 --max=10",
  },
  ...
  },
  {
    ...
    category: "Cluster",
    example: "kdrain node-1 --ignore-daemonsets",
  },
  {
    alias: "ktaint",
    command: "kubectl taint",
    description: "Taint node",
    category: "Cluster",
    example: "ktaint nodes node1 key=value:NoSchedule",
  },
];
...
export function AliasesReference() {
  ...
  const getCategoryIcon = (category: string) => {
    switch (category) {
      ...
      default:
        return <Command className="w-5 h-5 text-gray-500" />;
    }
  };
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white">
              Kubectl Aliases & Productivity
            </h2>
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Boost your efficiency with these time-saving aliases and functions
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="space-y-2">
              <div className="flex items-center gap-2 text-indigo-600 dark:text-indigo-400 font-medium">
                <span className="flex items-center justify-center w-6 h-6 rounded-full bg-indigo-100 dark:bg-indigo-900/50 text-xs">
                  1
                </span>
                Copy Configuration
              </div>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Click the "Copy All" button below to get the complete alias
                ...
                >
                  ...
                  {alias.example && (
                    <div className="mt-auto pt-2 border-t border-gray-100 dark:border-slate-700 flex items-center justify-between">
                      <code
                        className="text-xs text-gray-700 dark:text-gray-300 font-mono truncate mr-2"
                        title={alias.example}
                      >
                        {alias.example}
                      </code>
