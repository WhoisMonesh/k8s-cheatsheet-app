        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-blue-100 text-lg mb-6 max-w-2xl">
              The ultimate comprehensive interactive guide for DevOps engineers,
              SREs, and Kubernetes administrators. Master the CLI, troubleshoot
              clusters, and deploy with confidence.
            </p>
                ...
                <div className="w-full md:w-auto flex flex-col items-center">
                  ...
                  <div className="flex gap-2 mt-4">
                    <a
                      ...
                      className="p-2 text-slate-600 dark:text-slate-400 hover:text-brand-600 dark:hover:text-brand-400 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-full transition-colors"
                    >
                ...
                <div className="flex-1 space-y-6">
                  <div>
                    ...
                    <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
                      Passionate about building robust infrastructure and
                      developer tools. Specializing in Cloud Native
                      technologies, Kubernetes orchestration, and automating
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-slate-50 dark:bg-slate-900/50 p-4 rounded-lg border border-slate-100 dark:border-slate-700/50">
                      <h5 className="font-bold text-slate-900 dark:text-white mb-3 flex items-center gap-2">
                        <Cloud className="w-4 h-4 text-sky-500" /> Cloud &
                        Infrastructure
                      </h5>
                      <div className="flex flex-wrap gap-2">
                        {["AWS", "Azure", "Terraform", "Ansible"].map(
                          (skill) => (
                            <span
                              key={skill}
                              className="px-2 py-1 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded text-xs font-medium text-slate-600 dark:text-slate-300"
                            >
                              {skill}
                            </span>
                          ),
                    ...
                    <div className="bg-slate-50 dark:bg-slate-900/50 p-4 rounded-lg border border-slate-100 dark:border-slate-700/50">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {["Docker", "Podman", "Kubernetes", "Helm"].map(
                          (skill) => (
                            <span
                              key={skill}
                              className="px-2 py-1 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded text-xs font-medium text-slate-600 dark:text-slate-300"
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
            ...
            <div className="p-6">
              <p className="text-slate-600 dark:text-slate-400 mb-6 text-sm">
                If you find this cheatsheet helpful, consider starring the
                repository or contributing to its development.
              </p>
              <a
                href="https://github.com/WhoisMonesh"
                target="_blank"
