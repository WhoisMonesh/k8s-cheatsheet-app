...
export const karpenterCommandsData = [
  ...
  },
  {
    ...
    example:
      "helm upgrade --install karpenter oci://public.ecr.aws/karpenter/karpenter --namespace karpenter --create-namespace --version 0.32.0",
    versionIntroduced: "0.32.0",
    difficultyLevel: "advanced",
  ...
  // --- Advanced JSONPath & Filters for Karpenter ---
  {
    ...
    command:
      "kubectl get nodes -o custom-columns=NAME:.metadata.name,INSTANCE:.metadata.labels.karpenter\\.k8s\\.aws/instance-id,TYPE:.metadata.labels.node\\.kubernetes\\.io/instance-type",
  ...
  },
  {
    ...
    subcategory: "Advanced Queries",
    command:
      "kubectl get nodeclaims -o custom-columns=NAME:.metadata.name,NODE:.status.nodeName,INSTANCE:.status.providerID",
...
export const allKarpenterCommands = [
  ...karpenterCommandsData,
  ...generatedKarpenterCommands,
];
