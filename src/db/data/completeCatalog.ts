...
export const completeCatalogData = [
  ...
  },
  {
    ...
    example:
      "kubectl create service nodeport my-service --tcp=80:8080 --node-port=30000",
    versionIntroduced: "1.2",
    difficultyLevel: "intermediate",
  ...
  },
  {
    ...
    example:
      'kubectl create ingress my-ing --class=nginx --rule="example.com/*=service:80"',
    versionIntroduced: "1.19",
    difficultyLevel: "intermediate",
  ...
  },
  {
    ...
    example:
      "kubectl create ingress my-ing --default-backend=default-backend:80",
    versionIntroduced: "1.19",
    difficultyLevel: "intermediate",
...
pv-02   5Gi        Bound`,
  },
  {
    ...
    example:
      'kubectl patch pv pv-vol1 -p \'{"spec":{"persistentVolumeReclaimPolicy":"Retain"}}\'',
    versionIntroduced: "1.0",
    difficultyLevel: "advanced",
...
...`,
  },
  {
    ...
    example:
      "kubectl config set-cluster my-cluster --server=https://1.2.3.4 --certificate-authority=ca.crt",
    versionIntroduced: "1.0",
    difficultyLevel: "intermediate",
  ...
  },
  {
    ...
    flags:
      "--client-certificate, --client-key, --token, --username, --password",
  ...
  },
  {
    ...
    flags:
      "--ignore-daemonsets, --force, --delete-emptydir-data, --grace-period, --timeout",
    output: `node/worker-1 cordoned
...
node/worker-1 drained`,
  ...
  // Workload management (500+)
  {
    ...
    example:
      "kubectl create deployment webapp --image=webapp:v1 --replicas=3 --port=8080",
    versionIntroduced: "1.2",
    difficultyLevel: "beginner",
...
2m          Normal    Scheduled           pod/nginx               Successfully assigned default/nginx to worker-1`,
  },
  {
    ...
    example:
      "kubectl get events --field-selector type=Warning --sort-by=.lastTimestamp -A",
    versionIntroduced: "1.0",
    difficultyLevel: "intermediate",
