export const configurationCommandsData = [
  // Resource Quotas
  {
    ...
    command:
      "kubectl create quota my-quota --hard=pods=10,requests.cpu=4,limits.memory=10Gi",
...
prod        backend-pdb  80%             N/A               1                     10d`,
  ...
  // Generated Quota Creations
  {
    ...
    subcategory: "Resource Quotas",
    command:
      "kubectl create quota dev-quota --hard=pods=20,requests.cpu=2,limits.memory=4Gi -n dev",
  ...
  },
  {
    ...
    subcategory: "Resource Quotas",
    command:
      "kubectl create quota compute-resources --hard=cpu=1,memory=1Gi,pods=2,services=3,replicationcontrollers=1,resourcequotas=1,secrets=5,persistentvolumeclaims=10",
    description:
      "Create a comprehensive resource quota limiting multiple resource types",
    example:
      "kubectl create quota compute-resources --hard=cpu=1,memory=1Gi,pods=2,services=3,replicationcontrollers=1,resourcequotas=1,secrets=5,persistentvolumeclaims=10",
    versionIntroduced: "1.0",
  ...
  },
  {
    ...
    subcategory: "Resource Quotas",
    command:
      "kubectl create quota object-counts --hard=configmaps=10,persistentvolumeclaims=4,pods=4,replicationcontrollers=20,secrets=10,services=10,services.loadbalancers=2",
...
requests.cpu     2     4`,
  },
  {
    ...
    subcategory: "PDB",
    command:
      "kubectl create pdb frontend-pdb --selector=app=frontend --min-available=80%",
  ...
  },
  {
    ...
    subcategory: "PDB",
    command:
      "kubectl create pdb backend-pdb --selector=app=backend --max-unavailable=1",
  ...
  },
  {
    ...
    subcategory: "Limit Ranges",
    command:
      'kubectl patch limitrange my-limits --type=merge -p \'{"spec":{"limits":[{"type":"Container","default":{"cpu":"200m","memory":"512Mi"},"defaultRequest":{"cpu":"100m","memory":"256Mi"}}]}}\'',
    description:
      "Patch a LimitRange to update default CPU and memory limits/requests",
    example:
      'kubectl patch limitrange my-limits --type=merge -p \'{"spec":{"limits":[{"type":"Container","default":{"cpu":"200m","memory":"512Mi"},"defaultRequest":{"cpu":"100m","memory":"256Mi"}}]}}\'',
    versionIntroduced: "1.0",
    difficultyLevel: "advanced",
  ...
  },
  {
    ...
    subcategory: "ConfigMaps",
    command:
      "kubectl create configmap app-config --from-literal=log_level=debug --from-literal=ui_color=blue",
