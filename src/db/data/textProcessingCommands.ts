export const textProcessingCommandsData = [
  ...
  },
  {
    category: 'JSON Processing',
    subcategory: 'Pod Analysis',
    command: "kubectl get pods -A -o json | jq '.items[] | select(.status.phase==\"Running\") | .metadata.name'",
  ...
  },
  {
    category: 'JSON Processing',
    subcategory: 'Pod Analysis',
    command: "kubectl get pods -o json | jq '.items[] | select(.spec.containers[].image | contains(\"nginx\")) | .metadata.name'",
    description: 'Find pods running nginx images',
    example: "kubectl get pods -o json | jq '.items[] | select(.spec.containers[].image | contains(\"nginx\")) | .metadata.name'",
    versionIntroduced: '1.0',
    difficultyLevel: 'intermediate',
  ...
  },
  {
    ...
    command: "kubectl get nodes -o json | jq '.items[] | {name: .metadata.name, cpu: .status.capacity.cpu}'",
    description: 'Extract node CPU capacity',
    example: "kubectl get nodes -o json | jq '.items[] | {name: .metadata.name, cpu: .status.capacity.cpu}'",
    versionIntroduced: '1.0',
    difficultyLevel: 'intermediate',
  ...
  },
  {
    category: 'JSON Processing',
    subcategory: 'Events',
    command: "kubectl get events -o json | jq '.items[] | select(.type==\"Warning\") | {object: .involvedObject.name, message: .message}'",
    description: 'List all warning events with object name and message',
    example: "kubectl get events -o json | jq '.items[] | select(.type==\"Warning\") | {object: .involvedObject.name, message: .message}'",
    versionIntroduced: '1.0',
    difficultyLevel: 'intermediate',
  ...
  // Text Processing with awk
  {
    ...
    command: "kubectl get pods --all-namespaces | awk '$4 == \"Error\" || $4 == \"CrashLoopBackOff\" {print $1, $2}'",
    description: 'Find pods in Error or CrashLoopBackOff state across all namespaces',
    example: "kubectl get pods --all-namespaces | awk '$4 == \"Error\" || $4 == \"CrashLoopBackOff\" {print $1, $2}'",
    versionIntroduced: '1.0',
    difficultyLevel: 'intermediate',
  ...
  },
  {
    category: 'Text Processing',
    subcategory: 'Filtering',
    command: "kubectl get pods | awk '$3 == \"Error\" || $3 == \"CrashLoopBackOff\" {print $1}'",
    description: 'Find pods in Error or CrashLoopBackOff state in default namespace',
    example: "kubectl get pods | awk '$3 == \"Error\" || $3 == \"CrashLoopBackOff\" {print $1}'",
    versionIntroduced: '1.0',
    difficultyLevel: 'intermediate',
    tags: 'awk,pods,error,crashloop',
    flags: '',
  ...
  },
  {
    category: 'Text Processing',
    subcategory: 'Filtering',
    command: "kubectl get pods -n default | awk '$3 == \"Error\" || $3 == \"CrashLoopBackOff\" {print $1}'",
    description: 'Find pods in Error or CrashLoopBackOff state in default namespace explicitly',
    example: "kubectl get pods -n default | awk '$3 == \"Error\" || $3 == \"CrashLoopBackOff\" {print $1}'",
    versionIntroduced: '1.0',
    difficultyLevel: 'intermediate',
  ...
  },
  {
    category: 'Text Processing',
    subcategory: 'Filtering',
    command: "kubectl get pods -n <namespace> | awk '$3 == \"Error\" || $3 == \"CrashLoopBackOff\" {print $1}'",
    description: 'Find pods in Error or CrashLoopBackOff state in custom namespace',
    example: "kubectl get pods -n <namespace> | awk '$3 == \"Error\" || $3 == \"CrashLoopBackOff\" {print $1}'",
    versionIntroduced: '1.0',
    difficultyLevel: 'intermediate',
  ...
  },
  {
    category: 'Text Processing',
    subcategory: 'Stats',
    command: "kubectl top pods --all-namespaces | awk 'NR>1 {sum+=$3} END {print sum}'",
    description: 'Calculate total CPU usage of all pods (approximate from top output)',
    example: "kubectl top pods --all-namespaces | awk 'NR>1 {sum+=$3} END {print sum}'",
  ...
  // Advanced jq/yq
  {
    category: 'JSON Processing',
    subcategory: 'Secrets',
    command: "kubectl get secret my-secret -o json | jq -r '.data | map_values(@base64d)'",
    description: 'Decode all values in a secret',
    example: "kubectl get secret my-secret -o json | jq -r '.data | map_values(@base64d)'",
    versionIntroduced: '1.0',
    difficultyLevel: 'advanced',
  ...
  // More variations to increase count
  {
    ...
    description: 'Extract and display the data section from a ConfigMap in JSON format',
  ...
  },
  {
    ...
    description: 'Search for "Error" string in logs from all pods matching label app=nginx',
  ...
  },
  {
    ...
    description: 'Search for "Error" string in logs from all pods matching label app=nginx in all namespaces',
  ...
  },
  {
    ...
    command: "kubectl get serviceaccounts -o json | jq '.items[].metadata.name'",
    description: 'List all ServiceAccount names',
    example: "kubectl get serviceaccounts -o json | jq '.items[].metadata.name'",
    versionIntroduced: '1.0',
    difficultyLevel: 'beginner',
  ...
  },
  {
    category: 'JSON Processing',
    subcategory: 'Nodes',
    command: "kubectl get nodes -o json | jq '.items[] | select(.status.conditions[] | select(.type==\"Ready\" and .status==\"True\")) | .metadata.name'",
    description: 'List names of all Ready nodes',
    example: "kubectl get nodes -o json | jq '.items[] | select(.status.conditions[] | select(.type==\"Ready\" and .status==\"True\")) | .metadata.name'",
    versionIntroduced: '1.0',
    difficultyLevel: 'advanced',
