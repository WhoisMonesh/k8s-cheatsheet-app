...
export const consoleExercises: ConsoleExercise[] = [
  {
    ...
    description: 'Learn how to create, list, and delete pods in a Kubernetes cluster.',
    difficulty: 'beginner',
    tasks: [
      {
        id: 'list-pods',
...
redis-cache   1/1     Running   0          2h`
      },
      {
        ...
        successMessage: 'Excellent. Describe gives you events and status details.',
    ...
    tasks: [
      {
        ...
        expectedCommandRegex: '^kubectl create deployment web-app --image=nginx:1.19 --replicas=3$',
    ...
    tasks: [
      {
        ...
        expectedCommandRegex: '^kubectl expose pod nginx-pod --port=80 --name=nginx-svc$',
