...
Handling connection for 8080`
  ...
  },
  {
    category: 'Comprehensive kubectl',
    subcategory: 'Intermediate Operations',
    command: 'kubectl patch deployment my-deploy -p \'{"spec":{"replicas":5}}\'',
    description: 'Partially update a deployment',
    example: 'kubectl patch deployment my-deploy -p \'{"spec":{"replicas":5}}\'',
    versionIntroduced: '1.0',
    difficultyLevel: 'Intermediate',
...
5m          Normal    Scheduled   pod/my-pod      Successfully assigned default/my-pod to worker-node`
  },
  {
    ...
    command: 'kubectl get pods -o json | jq \'.items[] | {name: .metadata.name, status: .status.phase}\'',
    description: 'Process pod information with jq',
    example: 'kubectl get pods -o json | jq \'.items[] | {name: .metadata.name, status: .status.phase}\'',
    versionIntroduced: '1.0',
...
}
{
  ...
  },
  {
    category: 'Comprehensive kubectl',
    subcategory: 'Expert Operations',
    command: 'kubectl get pods --all-namespaces -o json | jq \'.items[] | select(.status.phase == \"Failed\") | .metadata.name\'',
    description: 'Find all failed pods across namespaces',
    example: 'kubectl get pods --all-namespaces -o json | jq \'.items[] | select(.status.phase == \"Failed\") | .metadata.name\'',
    versionIntroduced: '1.0',
    difficultyLevel: 'Expert',
  ...
  },
  {
    category: 'Comprehensive kubectl',
    subcategory: 'Expert Operations',
    command: 'kubectl get pods -o json | jq \'.items[] | select(.spec.containers[].resources.requests.cpu) | {name: .metadata.name, cpu: .spec.containers[0].resources.requests.cpu}\'',
    description: 'Find pods with CPU requests',
    example: 'kubectl get pods -o json | jq \'.items[] | select(.spec.containers[].resources.requests.cpu) | {name: .metadata.name, cpu: .spec.containers[0].resources.requests.cpu}\'',
    versionIntroduced: '1.0',
    difficultyLevel: 'Expert',
...
new-pod      1/1     Running   0          5m`
  },
  {
    category: 'Comprehensive kubectl',
    subcategory: 'Expert Operations',
    command: 'kubectl get pods -o json | jq \'.items[] | select(.status.containerStatuses[].restartCount > 5) | .metadata.name\'',
    description: 'Find pods with high restart count',
    example: 'kubectl get pods -o json | jq \'.items[] | select(.status.containerStatuses[].restartCount > 5) | .metadata.name\'',
    versionIntroduced: '1.0',
    difficultyLevel: 'Expert',
  ...
  },
  {
    category: 'Comprehensive kubectl',
    subcategory: 'Expert Operations',
    command: 'kubectl auth can-i create pods --as=system:serviceaccount:default:my-sa',
    description: 'Check permissions for specific service account',
    example: 'kubectl auth can-i create pods --as=system:serviceaccount:default:my-sa',
    versionIntroduced: '1.8',
    difficultyLevel: 'Expert',
  ...
  },
  {
    category: 'Comprehensive kubectl',
    subcategory: 'Expert Operations',
    command: 'kubectl get pods -o json | jq \'.items[] | select(.spec.securityContext.runAsNonRoot == true) | .metadata.name\'',
    description: 'Find pods with non-root security context',
    example: 'kubectl get pods -o json | jq \'.items[] | select(.spec.securityContext.runAsNonRoot == true) | .metadata.name\'',
    versionIntroduced: '1.0',
    difficultyLevel: 'Expert',
  ...
  },
  {
    category: 'Comprehensive kubectl',
    subcategory: 'Expert Operations',
    command: 'kubectl get nodes -o json | jq \'.items[] | {name: .metadata.name, os: .status.nodeInfo.osImage, kernel: .status.nodeInfo.kernelVersion}\'',
    description: 'Get node OS information',
    example: 'kubectl get nodes -o json | jq \'.items[] | {name: .metadata.name, os: .status.nodeInfo.osImage, kernel: .status.nodeInfo.kernelVersion}\'',
    versionIntroduced: '1.0',
    difficultyLevel: 'Expert',
...
spec:
  ...
  },
 {
    ...
    description: 'Find pods with non-root security context across all namespaces',
  ...
  },
  {
    ...
    output: 'Creating debugging pod node-debugger-worker-1-abcde with container debugger on node worker-1.\nIf you don\'t see a command prompt, try pressing enter.\nroot@worker-1:/# '
  },
  {
    category: 'Comprehensive kubectl',
    subcategory: 'Expert Operations',
  ...
  },
  {
    category: 'Comprehensive kubectl',
    subcategory: 'Expert Operations',
    command: 'kubectl get pods -o json | jq \'.items[] | select(.status.containerStatuses[].ready == false) | {name: .metadata.name, notReadyReason: .status.containerStatuses[] | select(.ready == false) | .state.waiting.reason}\'',
    description: 'Find not-ready pods with their reasons',
    example: 'kubectl get pods -o json | jq \'.items[] | select(.status.containerStatuses[].ready == false) | {name: .metadata.name, notReadyReason: .status.containerStatuses[] | select(.ready == false) | .state.waiting.reason}\'',
    versionIntroduced: '1.0',
    difficultyLevel: 'Expert',
