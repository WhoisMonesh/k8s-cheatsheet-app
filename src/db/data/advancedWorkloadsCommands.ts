...
kube-system coredns-5d78c     2         2         2       30d`
  },,
  {
    ...
    example: 'kubectl describe replicaset frontend-6c5f7\nkubectl describe replicaset frontend-6c5f7 -n prod',
    versionIntroduced: '1.0',
    difficultyLevel: 'beginner',
...
Pods Status:    3 Running / 0 Waiting / 0 Succeeded / 0 Failed`
  },
  {
    ...
    description: 'Show detailed information about all ReplicaSets in all namespaces',
...
...`
  },
  {
    ...
    example: 'kubectl scale replicaset frontend-6c5f7 --replicas=5\nkubectl scale replicaset frontend-6c5f7 --replicas=5 -n prod',
    versionIntroduced: '1.0',
    difficultyLevel: 'intermediate',
