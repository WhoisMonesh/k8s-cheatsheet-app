export const scenariosData = [
  {
    ...
    description:
      "Step-by-step guide to diagnosing why a pod is crashing repeatedly.",
    difficulty: "beginner",
    ...
    steps: [
      ...
      },
      {
        ...
        explanation:
          'Look for "Events" at the bottom. Check "State" and "Last State" of containers.',
        output:
      ...
      },
      {
        ...
        explanation:
          "If the pod crashes immediately, the current logs might be empty. Previous logs show why it died last time.",
        output:
          "nginx: [emerg] bind() to 0.0.0.0:80 failed (98: Address already in use)",
      },
    ],
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        explanation:
          "Creates a Service of type LoadBalancer to allow external access.",
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        explanation:
          "If something goes wrong, revert to the previous stable version.",
    ...
    steps: [
      {
        ...
        explanation:
          "Sets up autoscaling to maintain 50% CPU usage across pods.",
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        explanation:
          "Updates the deployment to use the ConfigMap data as env vars.",
...
EOF`,
        ...
        explanation:
          "Creates a NetworkPolicy that selects all pods and blocks all incoming traffic.",
