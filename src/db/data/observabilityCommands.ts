...
control-1     200m         10%    1500Mi          18%`,
  ...
  // Debugging
  {
    ...
    description:
      "Debug a node by creating a pod on it (Caution: Requires elevated privileges)",
...
/ #`,
  },
  {
    ...
    subcategory: "Debugging",
    command:
      "kubectl debug pod/my-pod -it --copy-to=my-debugger --image=busybox",
    description: "Debug a pod by creating a copy with a debug container",
    example:
      "kubectl debug pod/frontend-123 -it --copy-to=frontend-debug --image=busybox",
    versionIntroduced: "1.18",
    difficultyLevel: "intermediate",
    tags: "debug,pod,copy",
    flags: "--copy-to --image",
