...
Events:          <none>`,
  },
  {
    ...
    description:
      "Release a PV by clearing the claim reference (Warning: Can lead to data loss/inconsistency)",
  ...
  // Persistent Volume Claim Operations
  {
    ...
    subcategory: "Persistent Volume Claims",
    command:
      'kubectl patch pvc my-claim -p \'{"spec":{"resources":{"requests":{"storage":"100Gi"}}}}\'',
...
prom-storage  Bound    pv-002   10Gi       RWO            standard       10d`,
  },
  {
    ...
    command: "kubectl delete pvc --all",
    description:
      "Delete all PVCs in current namespace (Warning: This will delete all data volumes)",
    example: "kubectl delete pvc --all",
    versionIntroduced: "1.0",
    difficultyLevel: "advanced",
    tags: "pvc,delete,all",
