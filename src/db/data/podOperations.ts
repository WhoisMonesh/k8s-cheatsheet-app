export const podOperationsData = [
  ...
  },
  {
    ...
    example: 'kubectl run test --image=busybox --restart=Never --command -- echo "Hello"',
    versionIntroduced: '1.0',
  ...
  },
  {
    ...
    example: 'kubectl run nginx --image=nginx --dry-run=client -o yaml > pod.yaml',
...
status: {}`
  },
  {
    ...
    example: 'kubectl run nginx --image=nginx --overrides=\'{"apiVersion":"v1","spec":{"nodeSelector":{"disktype":"ssd"}}}\'',
    versionIntroduced: '1.0',
  ...
  },
  {
    ...
    example: 'kubectl run backup --image=backup:latest --schedule="0 2 * * *" --restart=OnFailure',
    versionIntroduced: '1.0',
    difficultyLevel: 'intermediate',
  ...
  },
  {
    ...
    flags: '--image-pull-policy=Always, --image-pull-policy=IfNotPresent, --image-pull-policy=Never',
    output: 'pod/nginx created'
  },
  {
    category: 'Pods',
  ...
  },
  {
    ...
    example: 'kubectl run -it debug --image=busybox --leave-stdin-open --restart=Never',
    versionIntroduced: '1.0',
...
/ #`
  },
  {
    ...
    example: 'kubectl debug nginx --copy-to=nginx-debug --container=nginx --image=nginx:debug',
  ...
  },
  {
    ...
    example: 'kubectl debug nginx --image=busybox --share-processes --target=nginx',
    versionIntroduced: '1.18',
    difficultyLevel: 'expert',
...
/ #`
  },
  {
    ...
    example: 'kubectl debug nginx --copy-to=nginx-debug --set-image=nginx=nginx:debug',
    versionIntroduced: '1.20',
    difficultyLevel: 'advanced',
...
root@worker-1:/#`
  },
  {
    ...
    flags: '--profile=general, --profile=baseline, --profile=restricted, --profile=sysadmin, --profile=netadmin',
...
/ #`
  ...
  },
  {
    ...
    example: 'kubectl cp nginx:/app/data.txt ./data.txt --container=nginx-container',
    versionIntroduced: '1.0',
    difficultyLevel: 'intermediate',
...
nginx     10m          20Mi`
  ...
  },
  {
    ...
    example: 'kubectl wait pod/nginx --for=condition=PodScheduled --timeout=30s',
    versionIntroduced: '1.11',
    difficultyLevel: 'intermediate',
  ...
  },
  {
    ...
    example: 'kubectl wait pod/nginx --for=condition=ContainersReady --timeout=60s',
    versionIntroduced: '1.11',
    difficultyLevel: 'intermediate',
...
pod/db condition met`
  },
  {
    ...
    example: 'kubectl wait pods -l app=nginx --for=condition=Ready --timeout=60s',
    versionIntroduced: '1.11',
    difficultyLevel: 'intermediate',
...
Events:           <none>`
  ...
  // Pod security and policies (40+ commands)
  {
    ...
    example: 'kubectl label namespace default pod-security.kubernetes.io/enforce=restricted',
    versionIntroduced: '1.23',
    difficultyLevel: 'advanced',
    tags: 'label,namespace,pod-security,enforce',
    flags: 'pod-security.kubernetes.io/enforce=privileged, pod-security.kubernetes.io/enforce=baseline, pod-security.kubernetes.io/enforce=restricted',
  ...
  },
  {
    ...
    example: 'kubectl label namespace default pod-security.kubernetes.io/warn=baseline',
    versionIntroduced: '1.23',
    difficultyLevel: 'advanced',
    tags: 'label,namespace,pod-security,warn',
    flags: 'pod-security.kubernetes.io/warn=privileged, pod-security.kubernetes.io/warn=baseline, pod-security.kubernetes.io/warn=restricted',
    output: 'namespace/default labeled'
  },
  {
    category: 'Pods',
    ...
    example: 'kubectl label namespace default pod-security.kubernetes.io/audit=restricted',
    versionIntroduced: '1.23',
    difficultyLevel: 'advanced',
    tags: 'label,namespace,pod-security,audit',
    flags: 'pod-security.kubernetes.io/audit=privileged, pod-security.kubernetes.io/audit=baseline, pod-security.kubernetes.io/audit=restricted',
    output: 'namespace/default labeled'
  },
  {
    category: 'Pods',
    ...
    example: 'kubectl run nginx --image=nginx --overrides=\'{"spec":{"securityContext":{"runAsUser":1000}}}\'',
    versionIntroduced: '1.0',
    difficultyLevel: 'expert',
  ...
  },
  {
    ...
    example: 'kubectl run nginx --image=nginx --requests=cpu=100m,memory=256Mi --limits=cpu=500m,memory=512Mi',
    versionIntroduced: '1.0',
    difficultyLevel: 'intermediate',
  ...
  },
  {
    ...
    example: 'kubectl set resources pod nginx --limits=cpu=1,memory=1Gi --requests=cpu=500m,memory=512Mi',
    versionIntroduced: '1.0',
    difficultyLevel: 'advanced',
  ...
  // Pod with volumes (40+ commands)
  {
    ...
    example: 'kubectl run nginx --image=nginx --overrides=\'{"spec":{"volumes":[{"name":"data","emptyDir":{}}],"containers":[{"name":"nginx","image":"nginx","volumeMounts":[{"name":"data","mountPath":"/data"}]}]}}\'',
    versionIntroduced: '1.0',
    difficultyLevel: 'expert',
...
nginx     1/1     Running   0          5m    10.244.1.45    worker-1   <none>           <none>`
  },
  {
    ...
    example: 'kubectl get pods -o custom-columns=NAME:.metadata.name,IP:.status.podIP',
    versionIntroduced: '1.0',
    difficultyLevel: 'intermediate',
...
Escape character is '^]'.`
  },
  {
    ...
    example: 'kubectl run test --image=busybox --overrides=\'{"spec":{"hostNetwork":true}}\'',
    versionIntroduced: '1.0',
    difficultyLevel: 'advanced',
  ...
  // Pod scheduling (40+ commands)
  {
    ...
    example: 'kubectl run nginx --image=nginx --overrides=\'{"spec":{"nodeSelector":{"disktype":"ssd"}}}\'',
    versionIntroduced: '1.0',
    difficultyLevel: 'advanced',
  ...
  },
  {
    ...
    example: 'kubectl get pods -o custom-columns=NAME:.metadata.name,NODE:.spec.nodeName,STATUS:.status.phase',
    versionIntroduced: '1.0',
    difficultyLevel: 'intermediate',
