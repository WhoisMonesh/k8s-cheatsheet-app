...
|----------|------|-----------------|
| **Windows** | `K8s Cheatsheet Setup 1.0.1.exe` | [Download](https://github.com/WhoisMonesh/k8s-cheatsheet-app/releases/download/v1.0.1/K8s%20Cheatsheet%20Setup%201.0.1.exe) |
| **macOS** | `K8s Cheatsheet-1.0.1.dmg` | [Download](https://github.com/WhoisMonesh/k8s-cheatsheet-app/releases/download/v1.0.1/K8s%20Cheatsheet-1.0.1.dmg) |
| **Linux** | `K8s Cheatsheet-1.0.1.AppImage` | [Download](https://github.com/WhoisMonesh/k8s-cheatsheet-app/releases/download/v1.0.1/K8s%20Cheatsheet-1.0.1.AppImage) |
